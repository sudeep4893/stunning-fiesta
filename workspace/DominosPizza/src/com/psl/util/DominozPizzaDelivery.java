...
public interface DominozPizzaDelivery {
	...
	void populateData(String dishFile, String locationFile, List<Dish> dishs,
			Set<Location> locations);

	void calculateLocationForDistance(List<Dish> dishs, Set<Location> locations);

	List<Order> calculateOrder(String orderFile, List<Dish> dishs,
			Set<Location> locations);

	void freeDelivery(List<Order> orders, List<Dish> dishs,
			Set<Location> locations);
